# Generated by Django 4.2.6 on 2023-11-30 23:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to=base_app.models.message_filepath, validators=[django.core.validators.FileExtensionValidator({'gif', 'mp4', 'wav', 'avi', 'mkv', 'flv', 'png', 'webm', 'jpeg', 'mp3', 'ogg', 'mov', 'jpg', 'wmv'})])),
            ...
            options={
                'ordering': ('-created',),
                'indexes': [models.Index(models.OrderBy(models.F('created'), descending=True), name='pmsg_created_idx'), models.Index(models.OrderBy(models.F('edited'), descending=True), name='pmsg_edited_idx'), models.Index(django.db.models.functions.text.Lower('file_type'), name='pmsg_file_type_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='pchat',
