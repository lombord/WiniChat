...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='pchat',
            constraint=models.UniqueConstraint(fields=('from_user', 'to_user'), name='unique_chat', violation_error_message='Personal chat can be created only once between two users.'),
        ),
        migrations.AddConstraint(
            model_name='pchat',
