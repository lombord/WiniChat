# Generated by Django 4.2.6 on 2023-12-18 19:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=base_app.models.message_filepath, validators=[django.core.validators.FileExtensionValidator({'mkv', 'flv', 'jpg', 'gif', 'avi', 'ogg', 'wmv', 'mov', 'mp3', 'mp4', 'webm', 'jpeg', 'png', 'wav'})])),
