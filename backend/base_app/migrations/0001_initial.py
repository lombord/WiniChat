# Generated by Django 4.2.6 on 2023-12-14 19:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=base_app.models.message_filepath, validators=[django.core.validators.FileExtensionValidator({'gif', 'ogg', 'webm', 'avi', 'wmv', 'flv', 'wav', 'png', 'mkv', 'jpg', 'mov', 'mp3', 'jpeg', 'mp4'})])),
