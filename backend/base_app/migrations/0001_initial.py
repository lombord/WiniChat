# Generated by Django 4.2.6 on 2023-12-08 21:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=base_app.models.message_filepath, validators=[django.core.validators.FileExtensionValidator({'png', 'jpeg', 'ogg', 'mp4', 'mkv', 'wav', 'avi', 'wmv', 'gif', 'mov', 'webm', 'flv', 'mp3', 'jpg'})])),
        ...
        migrations.AddIndex(
            model_name='pmessage',
            index=models.Index(models.OrderBy(models.F('edited'), descending=True), name='pmsg_edited_idx'),
        ),
        migrations.AddIndex(
            model_name='pchat',
